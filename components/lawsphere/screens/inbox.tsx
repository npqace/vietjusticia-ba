  ...
  return (
    <div className="flex h-full flex-col bg-[var(--color-neutral-50)]">
      <header className="border-b border-gray-100 bg-white px-4 pb-3 pt-3">
        <h1 className="text-lg font-bold text-[var(--color-neutral-950)]">Danh Sách Hội Thoại</h1>
      ...
      <div className="flex-1 space-y-2 overflow-y-auto px-4 py-3">
          ...
          >
            ...
            <div className="min-w-0 flex-1">
              <div className="flex items-center justify-between gap-2">
                <p className="truncate text-sm font-bold text-[var(--color-neutral-950)]">{t.name}</p>
                <span className="shrink-0 text-[11px] text-[var(--color-neutral-500)]">{t.time}</span>
              </div>
              ...
              <div className="mt-1 flex items-center justify-between gap-2">
                <p className="truncate text-xs text-[var(--color-neutral-500)]">{t.preview}</p>
                {t.unread > 0 && (
        ...
        {filtered.length === 0 && (
          <p className="pt-10 text-center text-sm text-[var(--color-neutral-500)]">Không tìm thấy cuộc trò chuyện nào.</p>
        )}
      </div>
    </div>
  )
